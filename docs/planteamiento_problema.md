...
> Nota para el equipo: si se desea complementar con cifras de contexto adicionales (ej. adopción de IA docente, infraestructura escolar), agregar aquí citando la fuente exacta con enlace — evitar cifras sin verificar directamente en una fuente consultable.
...
3. Recibir una planeación didáctica STEM+ inicial, ajustada a la brecha, la conectividad, la zona y el grado — y profundizar conversando con el agente.
